...
VOID ShowTitle()
{
    ...
    std::vector<std::string> CheatTitle = {
        R"(
._______.________     .______ ____   ________..______.______ .______ .______ .___    
:_.  ___|    ___/     : .____ \   \_/   \__ _:: .____: __   \:      \:      \|   |   
|  : |/\|___    \     | : _/\  \___ ___/  |  :| : _/\|  \____|       |   .   |   |   
|    /  |       /     |   /    /   _   \  |   |   /  |   :  \|   |   |   :   |   |/\ 
|. _____|__:___/      |_.: __ /___/ \___  |   |_.: __|   |___|___|   |___|   |   /  \
 ...
 :                                                                                   
    ...
    {
        SetConsoleTextColor(ImColor(12, 23, 240, 255));
    ...
    if (CS2::ProcID > 0 && CS2::ClientDll > 0)
    {
        SetConsoleTextColor(ImColor(12, 23, 240, 255));
        std::cout << '\n';
        std::cout << " [+] CS2 Process ID : " << CS2::ProcID << '\n';
        std::cout << '\n';
        std::cout << " [+] Retrieving Module Address\n";
        Sleep(500);
        std::cout << '\n';
        std::cout << " Client Address : " << CS2::ClientDll << '\n';
        std::cout << " Engine2 Address : " << CS2::Engine2Dll << '\n';
        std::cout << " Inputsystem Address : " << CS2::InputsystemDll << '\n';
        std::cout << " Matchmaking Address : " << CS2::MatchMakingDll << '\n';
        std::cout << " Soundsystem Address : " << CS2::SoundsystemDll << '\n';
        std::cout << " Server Address : " << CS2::ServerDll << '\n';
        std::cout << '\n';
    }
    else
    {
        ...
        std::cout << " Server Address : " << CS2::ServerDll << '\n';
        std::cout << '\n';
        std::cout << "  Cheat Failed To Attach! \n";
    }

    // Wait for 4 seconds before hiding the console
    Sleep(4000);
