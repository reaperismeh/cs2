...
public:
	...
	void UpdateLocalPlayer() {
		...
		localplayerindex = mem.ReadMemory<int>(localPlayerPawn + Offsets::m_iIDEntIndex);
		...
		FlashAlpha = mem.ReadMemory<float>(localPlayerPawn + Offsets::m_flFlashOverlayAlpha);
